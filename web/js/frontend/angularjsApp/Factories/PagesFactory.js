...
(function () {
    ...
    angular.module('BncFrontend.pagesFactory', []);
    ...
    function pagesFact($http) {
        ...
        factory.getPagesData = function($searchParamsCollection, successFnCallBack, errorFnCallBack){
            $http({
                method: "post",
                url: Routing.generate('dh_pages_collection'),
                headers: {
    ...
    angular.module('BncFrontend.pagesFactory').factory('pagesFact',pagesFact);
