...
(function () {
    ...
    angular.module('BncFrontend.newsFactory', []);
    ...
    function newsFact($http) {
        ...
        factory.getNewsData = function($searchParamsCollection, successFnCallBack, errorFnCallBack){
            $http({
                method: "post",
                url: Routing.generate('dh_posts_collection'),
                headers: {
    ...
    angular.module('BncFrontend.newsFactory').factory('newsFact',newsFact);
