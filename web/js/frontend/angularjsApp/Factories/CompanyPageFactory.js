...
(function () {
    ...
    angular.module('BncFrontend.companyPageFactory', []);


    /* Factory for handling Pages functions */
    function companyPageFact($http) {
        var factory = {};
        ...
        factory.getPageData = function($searchParamsCollection, successFnCallBack, errorFnCallBack){
            $http({
                method: "post",
                url: Routing.generate('dh_page_company_collection'),
                headers: {
    ...
    angular.module('BncFrontend.companyPageFactory').factory('companyPageFact',companyPageFact);
