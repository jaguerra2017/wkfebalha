...
(function () {
  ...
  angular.module('BncBackend.programDirective').directive('program', [function () {
    var directiveDefinitionObject = {
      ...
      '<a data-ng-if="userRole != \'ROLE_ADMIN\'" title="Reservar" data-ng-click="goBooking(show[room.id])" class="btn btn-circle-sm btn-primary"><span><i class="icon-tag"></i></span> </a>' +
