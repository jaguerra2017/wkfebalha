...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:index_old.html.twig', 'FooBundle:Post:index_old.html.twig', '@FooBundle/Resources/views/Post/index_old.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
